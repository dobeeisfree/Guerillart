...
Show.create(title: t.sample, content: "기타랑 목소리로 진행됩니다", genre: g.sample, start: "August 30, 2016 1:50 PM".to_time, playlist: "1.왜벌써가 2.링마이벨 3.날그만잊어요", location_x: 37.556022, location_y: 126.919755, creator_id: 9, location: "홍대 놀이터", status: 1)
...
Show.create(title: t.sample, content: "롯데타워에서 노래부릅니다", genre: g.sample, start: "December 31, 2016 11:50 PM".to_time, playlist: "1.거미야 2.아빌리브인리브 3.어른아이", location_x: 37.509901, location_y: 127.079183, creator_id: 9, location: "잠실", status: 1)
...
Show.create(title: t.sample, content: "롯데타워에서 노래부릅니다", genre: g.sample, start: "December 31, 2016 6:23 PM".to_time, playlist: "1.거미야 2.아빌리브인리브 3.어른아이", location_x: 37.511595, location_y: 127.079280, creator_id: 9, location: "잠실", status: 1)
